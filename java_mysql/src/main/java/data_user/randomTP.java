...
//        File file = new File("E:/java_mysql/src/main/java/data/subject_id.txt");
        File file = new File("E:/java_mysql/src/main/java/data_user/randomTP.txt");
        FileWriter fileWriter = new FileWriter(file);
        File file1 = new File("E:/java_mysql/src/main/java/data_user/TP.txt");
...
//            fileWriter.append(String.valueOf(rd.nextInt((100)) + 1));
//            fileWriter.append("\n");

//                if (i < 3000) {
            fileWriter.append(String.valueOf(tp.get(rd.nextInt(65))));
            fileWriter.append("\n");
