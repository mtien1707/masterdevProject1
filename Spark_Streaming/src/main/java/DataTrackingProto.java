...
// source: DataTracking.proto

public final class DataTrackingProto {
  private DataTrackingProto() {}
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return DataTrackingProto.internal_static_DataTracking_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return DataTrackingProto.internal_static_DataTracking_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DataTrackingProto.DataTracking.class, DataTrackingProto.DataTracking.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof DataTrackingProto.DataTracking)) {
        return super.equals(obj);
      }
      DataTrackingProto.DataTracking other = (DataTrackingProto.DataTracking) obj;
    ...
    public static DataTrackingProto.DataTracking parseFrom(
    ...
    public static DataTrackingProto.DataTracking parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DataTrackingProto.DataTracking parseFrom(
    ...
    public static DataTrackingProto.DataTracking parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DataTrackingProto.DataTracking parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DataTrackingProto.DataTracking parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DataTrackingProto.DataTracking prototype) {
    ...
    public static final class Builder extends
        ...
        DataTrackingProto.DataTrackingOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return DataTrackingProto.internal_static_DataTracking_descriptor;
      }
      ...
      // Construct using DataTrackingProto.DataTracking.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public DataTrackingProto.DataTracking getDefaultInstanceForType() {
        return DataTrackingProto.DataTracking.getDefaultInstance();
      }

      @java.lang.Override
      public DataTrackingProto.DataTracking build() {
        DataTrackingProto.DataTracking result = buildPartial();
      ...
      @java.lang.Override
      public DataTrackingProto.DataTracking buildPartial() {
        DataTrackingProto.DataTracking result = new DataTrackingProto.DataTracking(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DataTrackingProto.DataTracking) {
          return mergeFrom((DataTrackingProto.DataTracking)other);
        } else {
      ...
      public Builder mergeFrom(DataTrackingProto.DataTracking other) {
        if (other == DataTrackingProto.DataTracking.getDefaultInstance()) return this;
        if (other.hasVersion()) {
          bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DataTrackingProto.DataTracking parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DataTrackingProto.DataTracking) e.getUnfinishedMessage();
  ...
  bitField0_ |= 0x00000008;
    ...
    private static final DataTrackingProto.DataTracking DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DataTrackingProto.DataTracking();
    }

    public static DataTrackingProto.DataTracking getDefaultInstance() {
